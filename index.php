                                ...
                                <div class="card-body">
                                    <div class="media">
                                        <div class="media-body">
                                            ...
                                            <h5><?php echo number_format($stats -> totalUsers($odb), 0, ',', ','); ?></h5>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="media">
                                        <div class="media-body">
                                            ...
                                            <h5><?php echo $stats -> runningBoots($odb); ?></h5>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="media">
                                        <div class="media-body">
                                            ...
                                            <h5><?php echo number_format($stats -> totalBoots($odb), 0, ',', ','); ?></h5>
                                        </div>
                                        <div class="avatar-xs me-4">
                                            <div class="avatar-sm rounded-circle bg-primary align-self-center mini-stat-icon">
                                                <span class="avatar-title rounded-circle bg-primary">
...
?>
                                    ...
                                    <div>
                                     ...
                                     <i class="bx bx-down-arrow-circle h1 text-primary down-arrow-icon"></i>
                                        ...
                                        <div class="mt-3 px-3">
                                            <i class="mdi mdi-check text-success"></i> <?php echo $row['mbt']; ?> seconds<br>
                                            <i class="mdi mdi-check text-success"></i> <?php echo $row['nbr']; ?> concurrent<br>
                                            <?php $api = $row['api']; if($api == "1") { echo'<i class="mdi mdi-check text-success"></i>'; } else { echo'<i class="bx mr-2 bx-x text-danger"></i>'; } ?> Premium<br>
                                            <?php $api = $row['api']; if($api == "1") { echo'<i class="mdi mdi-check text-success"></i>'; } else { echo'<i class="bx mr-2 bx-x text-danger"></i>'; } ?> API Access
                                        </p>
                                        </div>
                                    </div>
                                </div>  <?php } ?>
                                                        ...
                                                        <div id="plans-accordion" class="accordion custom-accordion">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <div id="plans-collapseTwo" class="collapse" data-bs-parent="#plans-accordion">
                                                                    <div class="card-body">
                                                                        <p class="mb-0">Yes! Free stresser package is given to you automatically once you <a href="/register">register</a>.<br><br>You can always ask our support for a test-hit.<br><br>We care about our customers and allocate as much power as possible to them.</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="mb-3">
        ...
        <footer class="footer">
            <div class="container-fluid text-center">
                Copyright © <script>document.write(new Date().getFullYear())</script> <a href="https://L7Booter.ch"><?php echo $info["nom"]; ?></a>
            </div>
        </footer>
        </section>
